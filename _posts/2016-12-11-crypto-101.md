...
A great tool for performing automatic Lenght Extension attack is [HashPump](https://github.com/bwall/HashPump).

Alternatively if the challenge is using a custom hash or if you want to implement your own lenght ext. attack you can follow this [writeup](https://github.com/SPRITZ-Research-Group/ctf-writeups/tree/master/backdoorctf-2017/web/extends-me-250) from team **spritzer**.
...
There is a [script]({{ site.url }}/assets/crypto_ecb_eoracle.py) that do this for the [EncryptionService - ABCTF2016](https://kimiyuki.net/blog/2016/07/23/abctf-2016/) challenge
