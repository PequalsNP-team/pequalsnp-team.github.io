...
So it's possible to "update" an hash with new material.  
In this case if there is a public known collision, you can **append** the same message to get another collision.
